          ...
          {connections.map((connection,index)=>(
            <div className='w-full min-h-[100px] p-[20px] flex justify-between items-center'>
              <div className='flex justify-center items-center gap-[10px]'>
                  ...
                  <div className='text=[22px] font-semibold text-gray-600'>
              ...
              <div className='flex justify-center items-center gap-[10px]'>
                  <button className='text-[#18c5ff] font-semibold' onClick={()=>handleAcceptConnection(connection._id)}>
                    <IoIosCheckmarkCircleOutline className='w-[40px] h-[40px] cursor-pointer'/>
                  </button>



                  <button className='text-[#ff4218] font-semibold' onClick={()=>handleRejectConnection(connection._id)}>
                    <RxCrossCircled className='w-[40px] h-[40px] cursor-pointer'/>
                  </button>
              </div>
